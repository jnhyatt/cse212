...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: underlying queue returns elements in LIFO order instead of FIFO order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: implementation removes players with less than one turn instead of persisting infinitely.
